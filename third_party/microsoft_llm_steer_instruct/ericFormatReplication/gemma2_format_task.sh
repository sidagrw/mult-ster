...
cp "/content/drive/MyDrive/LLM_STEER_REPLICATION/google/gemma-2-2b-it/pre_computed_ivs_layer_20.h5" \
...
# mkdir -p /format/representations
# unzip -q "G:/My Drive/reps.zip" -d ./format/representations
# cp "G:/My Drive/LLM_STEER_REPLICATION/google/gemma-2-2b-it/pre_computed_ivs_layer_20.h5" \
#    "./format/representations/google/gemma-2-2b-it/all/pre_computed_ivs_layer_20.h5"
# MODEL="google/gemma-2-2b-it"
# BEST_LAYER=20
...
# /c/Users/Owner/AppData/Local/Programs/Python/Python312/python.exe format/precompute_ivs.py \
#         model_name="$MODEL" \
#         representations_folder="all" \
#         specific_layer=$BEST_LAYER
